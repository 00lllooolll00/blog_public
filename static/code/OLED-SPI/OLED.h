...
#define OLED_DC_PORT   OLED_DC_GPIO_Port //控制命令、数据口的Port
#define OLED_DC_PIN    OLED_DC_Pin //控制命令、数据口的Pin 输出、高速
#define OLED_REST_PORT OLED_RES_GPIO_Port //控制重启的引脚的Port
#define OLED_REST_PIN  OLED_RES_Pin //控制重启的引脚 输出、高速
#define OLED_CS_PORT   OLED_CS_GPIO_Port //软件片选
#define OLED_CS_PIN    OLED_CS_Pin //片选信号 输出、高速
...
typedef enum
{
    OLED_DMA_STAGE_CMD = 0,
    OLED_DMA_STAGE_DATA = 1
} OLED_DMA_STAGE_t;
